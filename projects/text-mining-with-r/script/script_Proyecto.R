...
class(Notas_0119_0719)

write.xlsx(x = Notas_0119_0719, file = "export/info_notas.xlsx")
...
otras_palabras <- c("s", "si", "x", "tres", "tal", "facts", "así", "sino",
                    ...
                    "va", "par", "aquellos", "sobretodo", "buscamos", "tras", "aun",
                    "b", "basa", "c", "carlos", "catorce", "ello", "cada", "ee", "tan")
